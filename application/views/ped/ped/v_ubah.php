...
echo form_open_multipart('ped/c_ped/update_ped', $attributes); 
?>
...
<legend></legend>
	...
	<label class="col-md-3 control-label" for="id_ped_sub">Nama Jenis Potensi </label>
		...
		<?php $id = 'id="id_ped_sub" class="form-control input-md" required';
			echo form_dropdown('id_ped_sub',$ped_sub,$ped->id_ped_sub,$id)?>
	...
	<label class="col-md-3 control-label" for="deskripsi">Nama Detil Potensi</label>
		<div class="col-md-9">
		<input class="form-control input-md" type="text" value="<?= $ped->deskripsi?>" name="deskripsi" placeholder="contoh: padi pak dodi / pantai parang tritis / tumpang sari #TS-1A " id="deskripsi" size="30" required />           
		<span class="help-block"></span>
		</div>
	</div>
	...
	<label class="col-md-3 control-label" for="luas">Luas Wilayah</label>
		<div class="col-md-9">
		<input class="form-control input-md" type="text" value="<?= $ped->luas?>" name="luas" id="luas" placeholder="Ha (contoh: 15.5)" onkeypress='validate(event)' size="30" required/> 
		<span class="help-block"></span>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="form-group">
			 ...
			 <div class="col-md-9">			 
				<input type="text" class="form-control" name="nik" id="nik" size="50" readonly="readonly" placeholder="NIK Pengelola (Kepala Keluarga)" value="<?= $ped->nik?>"/>
