...
echo form_open_multipart('ped/c_ped_kategori/simpan_ped_kategori', $attributes); 
?>
<legend></legend>

	<div class="form-group">
	<label class="col-md-3 control-label" for="deskripsi">Nama Lahan</label>
		<div class="col-md-9">
		<input class="form-control input-md" type="text" name="deskripsi" placeholder="contoh: Pertambangan / Pertanian / Wisata / Sumber Energi " id="deskripsi" size="30" required />           
