...
echo form_open_multipart('ped/c_ped_sub/update_ped_sub', $attributes); 
?>
...
<legend></legend>
	...
	<label class="col-md-3 control-label" for="id_ped_kategori">Lahan </label>
		...
		<?php $id = 'id="id_ped_kategori" class="form-control input-md" required';
			echo form_dropdown('id_ped_kategori',$ped_kategori,$ped_sub->id_ped_kategori,$id)?>
	...
	<label class="col-md-3 control-label" for="deskripsi">Nama Jenis Potensi</label>
		<div class="col-md-9">
		<input class="form-control input-md" type="text" value="<?= $ped_sub->deskripsi?>" name="deskripsi" placeholder="contoh: padi, danau, pantai " id="deskripsi" size="30" required />         
		<span class="help-block"></span>
		</div>
	</div>
	...
	<label class="col-md-3 control-label" for="monetize">Hasil / Satuan</label>
		<div class="col-md-6">
		<input class="form-control input-md" type="text" name="monetize" value="<?= $ped_sub->monetize?>" id="monetize" placeholder="Rp. (contoh : 150000)" onkeypress="return numbersonly(event)" size="30" required/> 
		<span class="help-block"></span>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<?php $id = 'id="satuan" class="form-control input-md" required';
			echo form_dropdown('satuan',$satuan,$ped_sub->satuan,$id)?>
		<span class="help-block"></span>
		</div>
	</div>
