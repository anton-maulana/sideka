...
<?php echo form_open('rencanaPembangunan/c_lpj/update_lpj/'); ?>
<legend></legend>
...
<input class="form-control input-md" type="text" name="id_spp" id="id_spp" value="<?= $spp1->id_spp ?>" /> 
<input class="form-control input-md" type="text" name="id_lpj" id="id_lpj" value="<?= $lpj->id_lpj ?>" /> 
	<legend></legend>
		...
		<div class="col-md-9">
			<span class="help-block">
			 <?php $id_spp = 'id="id_spp" class="form-control" required';
					echo form_dropdown('id_spp',$spp,$spp1->id_spp,$id_spp)?> 
	...
	<div class="form-group">
		...
		<div class="col-md-9">
			<span class="help-block">
				<input class="form-control input-md" type="text" name="penerima" id="penerima" placeholder="Penerima" value="<?= $lpj->penerima ?>"/> 
			</span>
		</div>
	</div>	
