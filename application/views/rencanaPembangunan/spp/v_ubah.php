...
<?php echo form_open('rencanaPembangunan/c_spp/update_spp/'); ?>
<legend></legend>
...
Mohon untuk diperhatikan, bagi isian data yang diberikan tanda <b><label style="color:red;">( * ) </label> wajib diisi.</b><br>
	...
	<input type="text" name="id_spp" id="id_spp" value="<?= $spp->id_spp ?>" size="20" />
	<!--
...
<legend></legend>
		...
		<div class="col-md-9">
			<span class="help-block">
			 <?php $id_rabdes = 'id="id_rabdes" class="form-control" required';
					echo form_dropdown('id_rabdes',$rabdes,$spp->id_rabdes,$id_rabdes)?> 
	...
	<label class="col-md-3 control-label" for="tgl_ambil">Tanggal Ambil <label style="color:red;"> *</label></label> 
		<div class="col-md-9">		
			...
			<input value="<?=date('d-m-Y', strtotime($spp->tgl_ambil))?>" type="text" class="form-control input-md"  name="tgl_ambil" id="tgl_ambil" size="20" readonly="readonly"/>
			</div>	
			</a>
		<span class="help-block">	
