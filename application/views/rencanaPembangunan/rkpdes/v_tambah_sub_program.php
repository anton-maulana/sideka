...
<?php echo form_open('rencanaPembangunan/c_rkpdes/simpan_sub_program/'); ?>
	...
	<input type="hidden" name="id_rpjmdes" id="id_rpjmdes" value="<?= $rkpdes->id_rpjmdes ?>" size="20" />
	<input type="hidden" name="id_tahun_anggaran" id="id_tahun_anggaran" value="<?= $rkpdes->id_tahun_anggaran ?>" size="20" />

	<div class="form-group">
		<label class="col-md-3 control-label" for="id_rpjmdes">Program RPJMDes <label style="color:red;"> *</label></label>
		<div class="col-md-9">
			<span class="help-block">
			 <?php $id_rpjmdes = 'id="id_rpjmdes" class="form-control" required DISABLED';
	...
	<div class="form-group">
		...
		<div class="col-md-9">
			<span class="help-block">
				<input value="<?= $rkpdes->program?>" class="form-control input-md" type="text" name="program" id="program" placeholder="Program RKPDes" disabled/> 
			</span>
		</div>
	</div>	
	
	<div class="form-group">
		<label class="col-md-3 control-label" for="program"> Sub Program RKPDes <label style="color:red;"> *</label></label> 
		<div class="col-md-9">
			<span class="help-block">
				<input class="form-control input-md" type="text" name="sub_program" id="sub_program" placeholder="Sub Program RKPDes"  /> 
			</span>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-md-9">
		<span class="help-block">
			<input class="form-control input-md" type="text" name="indikator" id="indikator" placeholder="Indikator"  /> 
		</span>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-md-9">
		<span class="help-block">
			<input class="form-control input-md" type="text" name="kondisi_awal" id="kondisi_awal" placeholder="Kondisi Awal" size="25" /> 
		</span>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-md-9">
		<span class="help-block">
			<input class="form-control input-md" type="text" name="target" id="target" placeholder="Target" size="25" /> 
		</span>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-md-9">
		<span class="help-block">
			<input class="form-control input-md" type="text" name="lokasi" id="lokasi" placeholder="Lokasi" size="25" /> 
		</span>
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<span class="help-block">
			<div class="input-group">
				...
				<input value="<?= $rkpdes->nominal?>" class="form-control input-md" type="text" name="nominal" id="nominal" placeholder="1000000 = Rp 1.000.000,-" 
	...
	<div class="form-group">
		...
		<span class="help-block">
			<div class="input-group">
				...
				<input placeholder="( Nominal Sumber Dana - Nominal )" value="" class="form-control input-md" type="text" name="sisa_sumber_dana" id="sisa_sumber_dana"  readonly/>
			</div>
...
<p>
	...
	{
	?>
		<input type="button" value="Batal" class="btn btn-danger" id="batal" onclick="location.href='<?= base_url() ?>rencanaPembangunan/c_rkpdes/show_detail_program/<?= $rkpdes->id_rkpdes; ?>'"/>
	<?php
	}
	?>
</p>
