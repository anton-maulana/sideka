...
<?php echo form_open('rencanaPembangunan/c_rkpdes/simpan_rkpdes/'); ?>
<legend></legend><div class="alert alert-warning" for="=">
...
<legend></legend>	
		...
		<div class="col-md-9">
			<span class="help-block">
			 <?php $id_rpjmdes = 'id="id_rpjmdes" class="form-control" required';
					echo form_dropdown('id_rpjmdes',$rpjmdes,'',$id_rpjmdes)?> 
			...
			<span class="help-block">
				<div id="lala">
					<?php $id_tahun_anggaran = 'id="id_tahun_anggaran" class="form-control" required';
							echo form_dropdown('id_tahun_anggaran',array('--Pilih Program RPJMDes Dahulu--'),'',$id_tahun_anggaran)?> 
	...
	<div class="form-group">
		...
		<div class="col-md-9">
			<span class="help-block">
				<input class="form-control input-md" type="text" name="program" id="program" placeholder="Program RKPDes"  /> 
			</span>
		</div>
	</div>	
		...
		<div class="col-md-9">
			<span class="help-block">
			 <?php $id_coa = 'id="id_coa" class="form-control" required';
					echo form_dropdown('id_coa',$coa,'',$id_coa)?> 
	...
	<div class="form-group">
		...
		<span class="help-block">
			<div class="input-group">
				...
				<input class="form-control input-md" type="text" name="nominal" id="nominal" placeholder="1000000 = Rp 1.000.000,-" 
		...
		<div class="col-md-9">
			<span class="help-block">
			 <?php $id_sumber_dana = 'id="id_sumber_dana" class="form-control" required';
					echo form_dropdown('id_sumber_dana',$sumber_dana,'',$id_sumber_dana)?> 
	...
	<div class="form-group">
		...
		<span class="help-block">
			<div class="input-group">
				...
				<div id="lala1">
					<input value="0" class="form-control input-md" type="text" name="nominal_sumber_dana" id="nominal_sumber_dana"  readonly/>
				</div>
			</div>
