...
echo form_open_multipart('aset/c_asal/update_asal', $attributes); 
?>

<input type="hidden" value="<?= $asal->id_asal_aset?>" name="id_asal_aset"/>  
...
<legend></legend>
	...
	<label class="col-md-3 control-label" for="deskripsi">Deskripsi</label>
		<div class="col-md-9">
		<input class="form-control input-md" value="<?= $asal->deskripsi?>" type="text" name="deskripsi" placeholder="deskripsi" id="deskripsi" size="30" required />           
