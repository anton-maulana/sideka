...
function edit_tanah(id) {
  window.location = _base_url + 'aset/c_tanah/edit/' + id;
}

function tambah_bangunan(id) {
  window.location = _base_url + 'aset/c_bangunan/add/' + id;
}
...
<div class="col-md-4">
	...
	<li class="dropdown">
		...
		<ul class="dropdown-menu dropdown-user">
			<li>
				<a href="<?php echo site_url('aset/c_tanah/export_to_excel/');?>"><i class="fa fa-download fa-fw"></i> Export ke Excel</a>
			</li>
		</ul>
	</li>
</ul> 
