...
echo form_open_multipart('aset/c_tanah/simpan_tanah', $attributes); 
?>
<legend></legend>
	...
	<label class="col-md-3 control-label" for="no_sertifikat">Nomor Sertifikat</label>
		<div class="col-md-9">
		<input class="form-control input-md" type="text" name="no_sertifikat" placeholder="contoh: 1107.06534.6693 " id="no_sertifikat" size="30" required />           
	...
	<label class="col-md-3 control-label" for="deskripsi">Deskripsi Tanah</label>
		<div class="col-md-9">
		<textarea name="deskripsi" placeholder="Deskripsi Tanah" class="form-control" rows="3" required></textarea>         
		<span class="help-block"></span>
		</div>
	</div>
