...
echo form_open_multipart('aset/c_ruangan/update_ruangan', $attributes); 
?>

<input type="hidden" value="<?= $ruangan->id_aset_ruangan?>" name="id_aset_ruangan"/>  
<!-- Form Name -->
	<legend></legend>
...
<legend></legend>
	...
	<label class="col-md-3 control-label" for="luas">Luas Ruangan</label>
		<div class="col-md-9">
		<input class="form-control input-md" value="<?= $bangunan->luas?>" type="text" name="luas" id="luas" placeholder="m2 (contoh: 15.5)" onkeypress='validate(event)' size="30" required /> 
		<span class="help-block"></span>
		</div>
	</div>
	...
	<label class="col-md-3 control-label" for="deskripsi">Nama Ruangan</label>
		<div class="col-md-9">
		<textarea name="deskripsi" placeholder="Deskripsi" class="form-control" rows="3" required><?= $ruangan->deskripsi?></textarea>         
		<span class="help-block"></span>
		</div>
	</div>
