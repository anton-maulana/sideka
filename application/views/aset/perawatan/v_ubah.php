	...
	<div class="form-group">
        ...
        <div class="col-md-9">
			...
			<div class="input-group">
				...
				<input class="form-control input-md" value="<?= date('d-m-Y', strtotime($perawatan->tgl_perawatan))?>" type="text" name="tgl_perawatan" id="ttl" size="20" readonly="readonly" placeholder="Tgl-Bln-Thn"/>						
			</div>
			<span class="help-block"></span>	
			</a>		
		</div>
