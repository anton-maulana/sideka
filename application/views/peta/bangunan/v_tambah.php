...
function startState(){
		...
		<?php 
			if($bangunan->lokasi != null OR $bangunan->lokasi != "")
			{
				echo $bangunan->lokasi; 
				?>
				///////////inisialiasi map lama/////////////////
				itBangunan<?= $bangunan->id_aset_bangunan?>.setMap(null);
				polyShape = new google.maps.Polygon(polyOptionsBangunan<?= $bangunan->id_aset_bangunan?>);
...
function logCode4(){
    ...
    gob('coords1').value = 'var myCoordinatesBangunan<?= $bangunan->id_aset_bangunan?> = [\n';
	var arrayLoc = '[';
    ...
    if(toolID == 2){
        gob('coords1').value += '];\n';
        var options = 'var polyOptionsBangunan<?= $bangunan->id_aset_bangunan?> = {\n'
        +'path: myCoordinatesBangunan<?= $bangunan->id_aset_bangunan?>,\n'
        ...
        +'}\n';
        gob('coords1').value += options;
        gob('coords1').value +='var itBangunan<?= $bangunan->id_aset_bangunan?> = new google.maps.Polygon(polyOptionsBangunan<?= $bangunan->id_aset_bangunan?>);\n'
		+'itBangunan<?= $bangunan->id_aset_bangunan?>.setMap(map);\n'
        +'var infoBangunan<?= $bangunan->id_aset_bangunan?> = new google.maps.InfoWindow({content: "<b>Aset Bangunan</b> <table><tr><td>No IMB</td><td> : <?= $bangunan->no_imb?></td></tr></tr><tr><td>Nama Bangunan</td><td> : <?= $bangunan->deskripsi?></td></tr><tr><td>Luas bangunan</td><td> : <?= $bangunan->luas?> Ha</td></table>"});\n'
        +'google.maps.event.addListener(itBangunan<?= $bangunan->id_aset_bangunan?>,"mouseover",function(){\n'
        +'	this.setOptions({strokeOpacity: "0.8",fillOpacity:"0.7"});\n'
		+'});\n'
		+'google.maps.event.addListener(itBangunan<?= $bangunan->id_aset_bangunan?>,"click",function(){\n'
        +'	this.setOptions({strokeOpacity: "0.9",fillOpacity:"0.8"});\n'
        +'	infoBangunan<?= $bangunan->id_aset_bangunan?>.open(map,itBangunan<?= $bangunan->id_aset_bangunan?>);\n'
		+'});\n'
        +'google.maps.event.addListener(itBangunan<?= $bangunan->id_aset_bangunan?>,"mouseout",function(){\n'
        +'	this.setOptions({strokeOpacity: "'+polygonstyles[pcur].lineopac+'",fillOpacity:"'+polygonstyles[pcur].fillopac+'"});\n'
        +'	infoBangunan<?= $bangunan->id_aset_bangunan?>.close(map,itBangunan<?= $bangunan->id_aset_bangunan?>);\n'
        +'});\n'
...
<script>
function nav_active(){
	document.getElementById("a-bangunan").className = "collapsed active";
}
...
<div class="row">
	...
	<div class="col-md-12">
		...
		<h5 style="float:right; "><b>No. IMB : <?= $bangunan->no_imb?></b></h5>							
		<br>
		<br>
		<legend></legend>
	</div>
	...
	echo form_open_multipart('peta/c_petaBangunan/simpan_peta', $attributes); 
	?>
	...
	<div class="form-group">
		...
		<div class="col-md-9">
			...
			<input type="button" value="Batal" id="batal" class="btn btn-danger" onclick="location.href='<?= base_url() ?>peta/c_petaBangunan'"/>
		</div>
	</div>
	<div id="presenter">
		<form action="#">
