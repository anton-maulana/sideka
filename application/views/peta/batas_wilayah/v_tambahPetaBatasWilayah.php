...
function startState(){
		...
		<?php 
			if($batas_wilayah != null OR $batas_wilayah != "")
			{
				echo $batas_wilayah; 
				?>
				///////////inisialiasi map lama/////////////////
				itBatasWilayah1.setMap(null);
				polyShape = new google.maps.Polygon(polyOptionsBatasWilayah1);
...
function logCode4(){
    ...
    gob('coords1').value = 'var myCoordinatesBatasWilayah1 = [\n';
	var arrayLoc = '[';
    ...
    if(toolID == 1){
        gob('coords1').value += '];\n';
        var options = 'var polyOptionsBatasWilayah1 = {\n'
        ...
        gob('coords1').value +='var itBatasWilayah1 = new google.maps.Polyline(polyOptionsBatasWilayah1);\n'
    ...
    if(toolID == 2){
        ...
        +'}\n';
        gob('coords1').value += options;
        gob('coords1').value +='var itBatasWilayah1 = new google.maps.Polygon(polyOptionsBatasWilayah1);\n'
		+'itBatasWilayah1.setMap(map);\n'
...
<script>
function nav_active(){
	document.getElementById("a-batas").className = "collapsed active";
}
...
<div class="row">
	...
	echo form_open_multipart('peta/c_petaBatasWilayah/simpan_peta', $attributes); 
	?>
	...
	<div class="form-group">
		...
		<div class="col-md-9">
			...
			<input type="button" value="Batal" id="batal" class="btn btn-danger" onclick="location.href='<?= base_url() ?>peta/c_petaBatasWilayah'"/>
		</div>
	</div>
	<div id="presenter">
		<form action="#">
