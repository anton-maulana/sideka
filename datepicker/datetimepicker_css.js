...
var EndYear = 15; //End Year offset. i.e. Current Year + 5
...
var WeekHeadColor="#f69e19";//var WeekHeadColor="#f69e19";//Background Color in Week header.
var SundayColor="#FF6A66";//var SundayColor="#FF6A66";//Background color of Sunday.
var SaturdayColor="#EAEAEA";//Background color of Saturday.
var WeekDayColor="white";//Background color of weekdays.
var FontColor="blue";//color of font in Calendar day cell.
var TodayColor="#fbd568";//var TodayColor="#fbd568";//Background color of today.
var SelDateColor = "#8DD53C";//var SelDateColor="#8DD53C";//Backgrond color of selected date in textbox.
var YrSelColor="#cc0033";//color of font of Year selector.
var MthSelColor="#cc0033";//color of font of Month selector if "MonthSelector" is "arrow".
var HoverColor="#75a8fe"; //color when mouse move over.
...
function RenderCssCal(bNewCal) {
	...
	vCalHeader="<table id='date' "+CalBgColor+" background='"+ThemeBg+"' border='0' cellpadding='1' cellspacing='3' width='200px' valign='top'>\n";

	//Table for Month & Year Selector

	vCalHeader+="<tr>\n<td colspan='7'>\n<table class='drop' border='0' width='200px' cellpadding='5' cellspacing='0'>\n<tr>\n";
  ...
  //******************End Month and Year selector in arrow******************************
	...
	if (winCal == undefined) {
     ...
     // add javascript function to the span cal
       ...
       with (span.style) {position = "absolute"; left = (xpos+8)+'px'; top = (ypos-8)+'px'; width = CalWidth+'px'; border = "solid 0pt " + SpanBorderColor; padding = "0pt"; cursor = "move"; backgroundColor = SpanBgColor; zIndex = 100;}
