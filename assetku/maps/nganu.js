...
var tinyIcon = new google.maps.MarkerImage(
    _base_url + 'icons/marker_20_red.png',
...
var imageNormal = new google.maps.MarkerImage(
	_base_url + "assetku/maps/images/circle.png",
	new google.maps.Size(11, 11),
	new google.maps.Point(0, 0),
	new google.maps.Point(6, 6)
);
var imageHover = new google.maps.MarkerImage(
	_base_url +  "assetku/maps/images/circle_over.png",
	new google.maps.Size(11, 11),
	new google.maps.Point(0, 0),
	new google.maps.Point(6, 6)
);
var imageNormalMidpoint = new google.maps.MarkerImage(
	_base_url +  "assetku/maps/images/circle_transparent.png",
	new google.maps.Size(11, 11),
	new google.maps.Point(0, 0),
	new google.maps.Point(6, 6)
);
...
function setDirectionsMarker(point) {
    var image = new google.maps.MarkerImage(_base_url + "assetku/maps/images/square.png");
...
function stopediting(){    
	...
	document.getElementById("simpan").disabled = false;
	editing = false;
    gob('EditButton').value = 'Membaikkan Garis';
...
// the "Membaikkan Garis" button has been pressed
function editlines(){	
...
function polylineintroduction() {
    gob('coords1').value = 'Ready for Polyline. Click on the map. The code for the shape you create will be presented here.\n\n'
                        ...
                        +'\nIf you want to edit a saved polyline or polygon, click on it. Then click Membaikkan Garis. '
